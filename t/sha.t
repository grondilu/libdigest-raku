...
subtest 'SHA-2', {
  ...
  is sha224(.key), Blob.new(parse-base(.value, 16).polymod(256 xx *).reverse), "SHA-2-224('{.key}')" for
  ...
  is sha384(.key), Blob.new(parse-base(.value, 16).polymod(256 xx *).reverse), "SHA-2-384('{.key}')" for
