...
subtest 'SHA-2', {
  ...
  is sha224(.key), Blob.new(.value.comb(/../).map(*.parse-base(16))), "SHA-2-224('{.key}')" for
  ...
  is sha256(.key), Blob.new(.value.comb(/../).map(*.parse-base(16))), "SHA-2-256('{.key}')" for
    'abc' => 'ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad',
    'abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq' => '248d6a61d20638b8e5c026930c3e6039a33ce45964ff2167f6ecedd419db06c1';

  is sha384(.key), Blob.new(.value.comb(/../).map(*.parse-base(16))), "SHA-2-384('{.key}')" for
  ...
  is sha512(.key), Blob.new(.value.comb(/../).map(*.parse-base(16))), "SHA-2-512('{.key}')" for
